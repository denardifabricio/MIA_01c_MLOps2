...
class PropertyPricePredictorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                '/predict.PropertyPricePredictor/Predict',
...
class PropertyPricePredictorServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_PropertyPricePredictorServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'predict.PropertyPricePredictor', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('predict.PropertyPricePredictor', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class PropertyPricePredictor(object):
    """Missing associated documentation comment in .proto file."""
